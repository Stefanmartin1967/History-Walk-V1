...
// à leurs handlers (render map/mobile, load/import circuit).
// La suppression d'un circuit n'y passe pas : le bouton du panneau appelle
// performCircuitDeletion directement (ui-circuit-editor.js).
